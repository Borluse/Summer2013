...
class mt_UI_Object{
  ...
  */
  ...
  function init_uiMaterials(){ //Hack: Hardcoded to materials in Resources folder
    materials[0] = GameObject.Instantiate(Resources.Load("Icon_Default")) as Material ;
    materials[1] = GameObject.Instantiate(Resources.Load("Icon_HiLite"))  as Material ;
    materials[2] = GameObject.Instantiate(Resources.Load("Icon_Red"))     as Material ;
  }                                                                                                  
}
